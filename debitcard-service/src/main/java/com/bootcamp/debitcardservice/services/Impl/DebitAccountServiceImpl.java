    ...
    public Mono<AccountRequest> findByAccountNumber(String typeofdebit, String accountNumber) {
        if(typeofdebit.equals("SAVING_ACCOUNT")){
            return webClientBuilder
                    .build()
                    .get()
                    .uri("localhost:9002/api/savingAccount/account/"+accountNumber)
                    .retrieve()
            ...
            return webClientBuilder
                    .build()
                    .get()
                    .uri("localhost:9004/api/currentAccount/account/"+accountNumber)
                    .retrieve()
                    .bodyToMono(AccountRequest.class)
                    .doOnNext(c->log.info("Account Response: Account Number={}", c.getAccountNumber() ));
            ...
            return webClientBuilder
                    .build()
                    .get()
                    .uri("localhost:9005/api/fixedTermAccount/account/"+accountNumber)
                    .retrieve()
                    .bodyToMono(AccountRequest.class)
                    .doOnNext(c->log.info("Account Response: Account Number={}", c.getAccountNumber() ));
        }else {
